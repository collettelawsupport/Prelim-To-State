...
export default function SupportPage() {
  return (
    <LegalShell eyebrow="Registration assistance" title="Support">
      <p>For help with a Prelim-to-State registration, a QuickBooks invoice, payment status, or the contestant Big Form, email <a href="mailto:texasolm2@gmail.com">texasolm2@gmail.com</a>.</p>
      ...
      <p><a className="button-primary legal-button" href="mailto:texasolm2@gmail.com?subject=Prelim-to-State%20registration%20support">Email registration support</a></p>
    </LegalShell>
  );
}
